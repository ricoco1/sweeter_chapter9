    ...
    try:
        ...
        if "file_give" in request.files:
            ...
            if file.filename != '':
                ...
                file_path = secure_filename(f"{username}.{extension}")
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            user_info = db.users.find_one({"username": post["username"]})
            post["profile_pic_real"] = user_info.get("profile_pic_real", "profile_placeholder.png")
...
@app.route("/get_post_username", methods=["GET"])
def get_post_username():
    ...
    try:
        ...
        if username_receive:
            ...
            return jsonify({"result": "fail", "msg": "No username provided"})
